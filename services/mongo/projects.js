        ...
        const results = (data === null ? [] : data)
          ...
          .map(project => {
            ...
            return {
              ...
              publications:
                project.publications === undefined ? [] : project.publications
            };
          });
    ...
    if (err) callback(err, null);
      ...
      if (project) {
        ...
        const errorMsg =
          ...
          translationObj["PROJECTS"] === undefined &&
          translationObj["PROJECTS"]["PROJECT_NOT_FOUND_MSG"] === undefined
            ? `${id} not found`
            : translationObj["PROJECTS"["PROJECT_NOT_FOUND_MSG"]];
